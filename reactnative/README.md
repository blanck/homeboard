...
2. **Register your own Tibber developer app** at <https://thewall.tibber.com> (native/desktop client, redirect URI `homeboard://oauth/tibber`), then put the values in `reactnative/src/secrets.local.js`.
